...
static symbol s_0_0[5] = { 'a', 'r', 's', 'e', 'n' };
static symbol s_0_1[6] = { 'c', 'o', 'm', 'm', 'u', 'n' };
static symbol s_0_2[5] = { 'g', 'e', 'n', 'e', 'r' };
    ...
    {   int c1 = z->c; /* do, line 35 */
        ...
        lab2:
            ...
            {    /* gopast */ /* grouping v, line 41 */
                int ret = out_grouping(z, g_v, 97, 121);
                if (ret < 0) goto lab0;
                z->c += ret;
            }
            {    /* gopast */ /* non v, line 41 */
                int ret = in_grouping(z, g_v, 97, 121);
                if (ret < 0) goto lab0;
                z->c += ret;
            }
        }
    ...
    switch(among_var) {
        ...
        case 2:
            {   int m1 = z->l - z->c; (void)m1; /* or, line 68 */
                ...
                {   slice_from_s(z, 1, s_6); /* <-, line 68 */
                    //if (ret < 0) return ret;
                }
                goto lab1;
            lab2:
                z->c = z->l - m1;
                {  slice_from_s(z, 2, s_7); /* <-, line 68 */
                    //if (ret < 0) return ret;
                }
            }
        lab1:
        ...
        case 3:
            ...
            {    /* gopast */ /* grouping v, line 69 */
                int ret = out_grouping_b(z, g_v, 97, 121);
                if (ret < 0) return 0;
                z->c -= ret;
            }
    ...
    switch(among_var) {
        ...
        case 2:
            ...
            switch(among_var) {
                ...
                case 1:
                    {   int c_keep = z->c;
                         insert_s(z, z->c, z->c, 1, s_9); /* <+, line 83 */
                        z->c = c_keep;
                        //if (ret < 0) return ret;
                    }
                    break;
                ...
                case 3:
                    ...
                    {   int c_keep = z->c;
                       insert_s(z, z->c, z->c, 1, s_10); /* <+, line 87 */
                        z->c = c_keep;
                        //if (ret < 0) return ret;
                    }
                    break;
...
static int r_Step_2(struct SN_env * z) {
    ...
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   slice_from_s(z, 4, s_14); /* <-, line 101 */
                //if (ret < 0) return ret;
            }
            break;
        case 2:
            {   slice_from_s(z, 4, s_15); /* <-, line 102 */
               // if (ret < 0) return ret;
            }
            break;
        case 3:
            {   slice_from_s(z, 4, s_16); /* <-, line 103 */
               // if (ret < 0) return ret;
            }
            break;
        case 4:
            {   slice_from_s(z, 4, s_17); /* <-, line 104 */
               // if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            break;
        case 6:
            {  slice_from_s(z, 3, s_19); /* <-, line 107 */
                //if (ret < 0) return ret;
            }
            break;
        case 7:
            ...
            break;
        case 8:
            {  slice_from_s(z, 2, s_21); /* <-, line 111 */
               // if (ret < 0) return ret;
            }
            break;
        case 9:
            {   slice_from_s(z, 3, s_22); /* <-, line 112 */
               // if (ret < 0) return ret;
            }
            break;
        case 10:
            {    slice_from_s(z, 3, s_23); /* <-, line 114 */
                //if (ret < 0) return ret;
            }
            break;
        case 11:
            {    slice_from_s(z, 3, s_24); /* <-, line 116 */
               // if (ret < 0) return ret;
            }
            break;
        case 12:
            {    slice_from_s(z, 3, s_25); /* <-, line 118 */
               // if (ret < 0) return ret;
            }
            break;
        case 13:
            if (!(eq_s_b(z, 1, s_26))) return 0;
            {    slice_from_s(z, 2, s_27); /* <-, line 119 */
               // if (ret < 0) return ret;
            }
            break;
        case 14:
            {   slice_from_s(z, 3, s_28); /* <-, line 120 */
                //if (ret < 0) return ret;
            }
            break;
        case 15:
            {   slice_from_s(z, 4, s_29); /* <-, line 121 */
               // if (ret < 0) return ret;
            }
            break;
        case 16:
...
static int r_Step_3(struct SN_env * z) {
    ...
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   slice_from_s(z, 4, s_30); /* <-, line 128 */
                //if (ret < 0) return ret;
            }
            break;
        case 2:
            {    slice_from_s(z, 3, s_31); /* <-, line 129 */
                //if (ret < 0) return ret;
            }
            break;
        case 3:
            {   slice_from_s(z, 2, s_32); /* <-, line 130 */
                //if (ret < 0) return ret;
            }
            break;
        case 4:
            {    slice_from_s(z, 2, s_33); /* <-, line 132 */
               // if (ret < 0) return ret;
            }
            break;
        case 5:
...
static int r_exception1(struct SN_env * z) {
    ...
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   slice_from_s(z, 3, s_37); /* <-, line 174 */
               // if (ret < 0) return ret;
            }
            break;
        case 2:
            {  slice_from_s(z, 3, s_38); /* <-, line 175 */
               // if (ret < 0) return ret;
            }
            break;
        case 3:
            {   slice_from_s(z, 3, s_39); /* <-, line 176 */
               // if (ret < 0) return ret;
            }
            break;
        case 4:
            {    slice_from_s(z, 3, s_40); /* <-, line 177 */
             //   if (ret < 0) return ret;
            }
            break;
        case 5:
            {   slice_from_s(z, 3, s_41); /* <-, line 178 */
               // if (ret < 0) return ret;
            }
            break;
        case 6:
            {   slice_from_s(z, 3, s_42); /* <-, line 182 */
               // if (ret < 0) return ret;
            }
            break;
        case 7:
            {   slice_from_s(z, 5, s_43); /* <-, line 183 */
               // if (ret < 0) return ret;
            }
            break;
        case 8:
            {   slice_from_s(z, 4, s_44); /* <-, line 184 */
                //if (ret < 0) return ret;
            }
            break;
        case 9:
            {    slice_from_s(z, 5, s_45); /* <-, line 185 */
               // if (ret < 0) return ret;
            }
            break;
        case 10:
            {    slice_from_s(z, 4, s_46); /* <-, line 186 */
               // if (ret < 0) return ret;
            }
            break;
        case 11:
            {  slice_from_s(z, 5, s_47); /* <-, line 187 */
                //if (ret < 0) return ret;
            }
            break;
    }
...
static int r_postlude(struct SN_env * z) {
    ...
    while(1) { /* repeat, line 203 */
        ...
        {   slice_from_s(z, 1, s_49); /* <-, line 203 */
           // if (ret < 0) return ret;
        }
        continue;
    lab0:
